# Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - Лоскутов В.В.
...
![терминал](https://github.com/NightWalkerZ488/-virt-docker-intro-HW/blob/main/4-1.png)
![терминал](https://github.com/NightWalkerZ488/-virt-docker-intro-HW/blob/main/4-2.png)

Создаём файлы внутри контейнра и на хосте.
![терминал](https://github.com/NightWalkerZ488/-virt-docker-intro-HW/blob/main/4-3png.png)
![терминал](https://github.com/NightWalkerZ488/-virt-docker-intro-HW/blob/main/4-4png.png)

Проверяем наличие файлов.
![терминал](https://github.com/NightWalkerZ488/-virt-docker-intro-HW/blob/main/4-5png.png)
